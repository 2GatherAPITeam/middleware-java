...
public class JSwitchBox extends AbstractButton {
	...
	public JSwitchBox(String trueLabel, String falseLabel, MouseListener mouseListener) {
		...
		thumbBounds  = new Dimension(max+gap*6,30);
		globalWitdh =  max + thumbBounds.width+gap*6;
